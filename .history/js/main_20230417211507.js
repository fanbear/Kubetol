    ...
    if (mainTabLinks) {
        mainTabLinks.forEach((mainLinks, i) => {
            mainLinks.addEventListener('click', (e) => {
                ...
                const optionLink = e.target.querySelectorAll('.option__head-item');
                const optionItems = e.target.querySelectorAll('.option__body-item');

                if (optionLink) {
                    optionLink.forEach((oLink) => {
                        oLink.classList.remove('option__head-active');
                    });
                    ...
                    oLink.classList.add('option__head-active');
