document.addEventListener('DOMContentLoaded', () => {
    ...
    headeMenuBtn.addEventListener('click', () => {
        ...
        if (!headerMenuList.classList.contains('header-menu__no-active') && !headerMenuList.classList.contains('header-menu__no-active')) {
            headerMenuList.classList.add('header-menu__active');
        }
        if (headerMenuList.classList.contains('header-menu__no-active')) {
