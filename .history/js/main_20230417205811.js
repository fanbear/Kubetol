document.addEventListener('DOMContentLoaded', () => {
    ...
    const mainTabLinks = document.querySelectorAll('.product-tab__head-active');
    ...
    if (mainTabLinks) {
        tabLinks.forEach((tabLink, i) => {
            tabLink.addEventListener('click', () => {
                /
                tabLinks.forEach((tabLink) => {
                    tabLink.classList.remove('product-tab__head-active');
                });
                tabItems.forEach((tabItem) => {
                ...
                tabLink.classList.add('product-tab__head-active');
                tabItems[i].classList.add('product-tab__body-active');
            });
        });
    }
