    ...
    if (mainTabLinks) {
        mainTabLinks.forEach((mainLinks, i) => {
            mainLinks.addEventListener('click', (e) => {
                ...
                const optionLink = mainLinks.querySelectorAll('.option__head-item');
                const optionItems = mainLinks.querySelectorAll('.option__body-item');
                console.log(optionLink);
                if (optionLink) {
                    optionLink.forEach((item, i) => {
                        item.classList.remove('option__head-active');
                    });

                    optionItems.forEach((tabItem) => {
                        tabItem.classList.remove('option__body-active');
                    });


                    item.classList.add('option__head-active');
                    optionItems[i].classList.add('option__body-active');
                }
