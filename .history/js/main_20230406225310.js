document.addEventListener('DOMContentLoaded', () => {
    ...
    const nextBtn = document.querySelector('.kubetol-shipped__slider .owl-next');
    const prevBtn = document.querySelector('.kubetol-shipped__slider .owl-prev');

    const changeDataSlider = dateSlideList.forEach((item, i) => {
